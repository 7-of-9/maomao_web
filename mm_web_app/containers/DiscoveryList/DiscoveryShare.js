...
import StepTwo from '../../components/ShareTopic/StepTwo'
import StepThree from '../../components/ShareTopic/StepThree'
...
const enhance = compose(
  ...
  withHandlers({
    ...
    sendEmails: props => () => {
      if (props.recipients.length) {
        ...
        const url = `${SITE_URL}/${props.shareCode}`
  ...
  onlyUpdateForKeys(['contacts', 'currentStep', 'shareCode', 'type', 'shareOption'])
)
