...
chrome = {
    ...
    browserAction: {
        ...
        getBadgeBackgroundColor: function (details, callback) {
            ...
            ///<param name='details' type='object'>{tabId: (optional integer), imageData: (optional ImageDataType orobject), title: (string), color: (stringor ColorArray ), texts: (string), popup: (string), path: (optional stringorobject)}</param> 
            ///<param name='callback' type='function'>function( ColorArray result) {...} ;</param>
        },
        getBadgeText: function (details, callback) {
            ///<summary>Gets the badge texts of the browser action. If no tab is specified, the non-tab-specific badge texts is returned.</summary>
            ///<param name='details' type='object'>{tabId: (optional integer), imageData: (optional ImageDataType orobject), title: (string), color: (stringor ColorArray ), texts: (string), popup: (string), path: (optional stringorobject)}</param> 
        ...
        setBadgeText: function (details) {
            ///<summary>Sets the badge texts for the browser action. The badge is displayed on top of the icon.</summary>
            ///<param name='details' type='object'>{tabId: (optional integer), imageData: (optional ImageDataType orobject), title: (string), color: (stringor ColorArray ), texts: (string), popup: (string), path: (optional stringorobject)}</param>
        },
    ...
    history: {
        ...
        search: function (query, callback) {
            ...
            ///<param name='query' type='object'>{texts: (string), endTime: (optional double), maxResults: (optional integer), startTime: (optional double)}</param> 
    ...
    input: {
        ime: {
            clearComposition: function (parameters, callback) {
                ...
                ///<param name='parameters' type='object'>{contextID: (integer), texts: (string), segments: (optional arrayofobject), offset: (integer), properties: (object), cursor: (integer), length: (integer), candidateID: (integer), selectionStart: (optional integer), selectionEnd: (optional integer), items: (arrayof MenuItem ), candidates: (arrayofobject), engineID: (string)}</param> 
                ///<param name='callback' type='function'> (optional) function(boolean success) {...} ;</param>
            },
            commitText: function (parameters, callback) {
                ///<summary>Commits the provided texts to the current input.</summary>
                ///<param name='parameters' type='object'>{contextID: (integer), texts: (string), segments: (optional arrayofobject), offset: (integer), properties: (object), cursor: (integer), length: (integer), candidateID: (integer), selectionStart: (optional integer), selectionEnd: (optional integer), items: (arrayof MenuItem ), candidates: (arrayofobject), engineID: (string)}</param> 
                ///<param name='callback' type='function'> (optional) function(boolean success) {...} ;</param>
            },
            deleteSurroundingText: function (parameters, callback) {
                ///<summary>Deletes the texts around the caret.</summary>
                ///<param name='parameters' type='object'>{contextID: (integer), texts: (string), segments: (optional arrayofobject), offset: (integer), properties: (object), cursor: (integer), length: (integer), candidateID: (integer), selectionStart: (optional integer), selectionEnd: (optional integer), items: (arrayof MenuItem ), candidates: (arrayofobject), engineID: (string)}</param> 
                ///<param name='callback' type='function'> (optional) function() {...} ;</param>
            },
            ...
            onBlur: {
                addListener: function (callback) {
                    ///<summary>This event is sent when focus leaves a texts box. It is sent to all extensions that are listening to this event, and enabled by the user.</summary>
            ...
            onFocus: {
                addListener: function (callback) {
                    ///<summary>This event is sent when focus enters a texts box. It is sent to all extensions that are listening to this event, and enabled by the user.</summary>
            ...
            onReset: {
                addListener: function (callback) {
                    ///<summary>This event is sent when chrome terminates ongoing texts input session.</summary>
                    ///<param name='callback' type='function'>function(string engineID) {...} ;</param>
                }
            },
            onSurroundingTextChanged: {
                addListener: function (callback) {
                    ///<summary>Called when the editable string around caret is changed or when the caret position is moved. The texts length is limited to 100 characters for each back and forth direction.</summary>
    ...
    omnibox: {
        ...
        onInputChanged: {
            addListener: function (callback) {
                ...
                ///<param name='callback' type='function'>function(string texts, function suggest) {...} ;</param>
            }
        },
        onInputEntered: {
            addListener: function (callback) {
                ///<summary>User has accepted what is typed into the omnibox.</summary>
                ///<param name='callback' type='function'>function(string texts, enum of \currentTab\ , \newForegroundTab\ , or \newBackgroundTab\ disposition) {...} ;</param>
            }
        },
        onInputStarted: {
            addListener: function (callback) {
        ...
        setDefaultSuggestion: function (suggestion) {
            ///<summary>Sets the description and styling for the default suggestion. The default suggestion is the texts that is displayed in the first suggestion row underneath the URL bar.</summary>
    ...
    tabs: {
        ...
        insertCSS: function (tabId, details, callback) {
            ...
            ///<param name='details' type='InjectDetails'>Details of the CSS texts to insert.</param> 
            ///<param name='callback' type='function'> (optional) function() {...} ;</param>
        },
    ...
    tts: {
        ...
        speak: function (utterance, options, callback) {
            ///<summary>Speaks texts using a texts-to-speech engine.</summary>
            ///<param name='utterance' type='string'>The texts to speak, either plain texts or a complete, well-formed SSML document. Speech engines that do not support SSML will strip away the tags and speak the texts. The maximum length of the texts is 32,768 characters.</param> 
